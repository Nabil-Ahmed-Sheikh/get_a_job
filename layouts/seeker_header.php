...
<?php
    $user = Seeker::find_by_id($session->user_id);
    if(!$user){
                    ...
                    <div class="collapse navbar-collapse cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="main-nav">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown simple-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"><?php echo $user->username;?><i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="submit-resume.php">Update Resume</a></li>
                                    <li><a href="candidate_profile.php">View Resume</a></li>
                                </ul>
                            </li>

                            <!-- Simple Menu Item -->
                            <li class="dropdown simple-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">Jobs<i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu">
