...
class Answer {
    ...
    protected static $db_fields = array('id', 'qid', 'ans', 'corrAns', 'scId', 'submitDate', 'score');
  ...
  public static function find_by_sql($sql="") {
	...
	public static function find_by_scId($scId=0) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE scId={$scId}");	 
	}
	...
	public static function change_password($id, $password) {
		global $database;
		$sql = "UPDATE seeker SET `password` = "."'".$password."'"." WHERE id=".$id;
		$database->query($sql);
