...
$total_count = Circular::count_by_uid($session->user_id);
...
$sql = "SELECT * from circular where uid = {$session->user_id} Limit {$per_page} OFFSET {$pagination->offset()}";
$circulars = Circular::find_by_sql($sql);
                        ...
                        <div class="single-candidate row nomargin">
                            ...
                            <div class="col-md-2 col-xs-3">
                                <div class="candidate-img">
                                    <a href="<?php echo 'job-page.php?id='.$circular->id;?>">
                                        <img src=<?php echo "../images/company/".$circular->photo; ?> class="img-responsive" alt="">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 col-xs-6 ptb20">
                                ...
                                <div class="candidate-name">
                                    <a href="<?php echo 'job-page.php?id='.$circular->id;?>"><h5 class="H3GREEN"><?php echo $circular->companyName; ?></h5></a>
                                </div>
                                ...
                                <div class="candidate-info mt5">
                                    <ul class="list-inline">
                                        <li>
                                            <span><i class="fa fa-money"></i><?php echo $circular->salaryMin." - ".$circular->salaryMax; ?></span>
                                        </li>

                                        <li>
                                            <span><i class="fa fa-map-marker"></i><?php echo $circular->location; ?></span>
                                        </li>
                    ...
                    <div class="col-md-12 mt10">
                        <ul class="pagination list-inline text-center">
                            ...
                            <?php   if($pagination->has_previous_page()) { ?>
                                <li><a href="circular_list.php?page=<?php echo $pagination->previous_page();?>">Previous</a></li>
                            <?php } ?>
                            ...
                            <?php   } else { ?>
                                        <li><a href="circular_list.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    
                            <?php        }
                                    } ?>

                            <?php   if($pagination->has_next_page()) { ?>
                                <li><a href="circular_list.php?page=<?php echo $pagination->next_page();?>">Next</a></li>
